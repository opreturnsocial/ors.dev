      ...
      <header className="sticky top-0 z-50 border-b border-border/60 bg-background/90 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className="font-mono font-bold text-[#f7931a] tracking-tight">
              ORS
            </span>
          ...
          <div className="flex items-center gap-4">
            <nav className="hidden md:flex items-center gap-4">
              <a
                href="#how-it-works"
                className="font-mono text-xs text-muted-foreground hover:text-foreground tracking-widest transition-colors"
              >
                HOW IT WORKS
              </a>
              <span className="text-border/60">|</span>
