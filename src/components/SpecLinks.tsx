...
const specs: SpecLink[] = [
  ...
  },
  {
    id: 'ORK-03',
    title: 'TEXT_REPLY',
    description: 'Reply to an ORS transaction by txid (kind 0x03)',
  ...
  },
  {
    id: 'ORK-04',
    title: 'REPOST',
    description: 'Repost another ORS transaction (kind 0x04)',
  ...
  },
  {
    id: 'ORK-05',
    title: 'QUOTE_REPOST',
    description: 'Quote repost another ORS transaction (kind 0x05)',
